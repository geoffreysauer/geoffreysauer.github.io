<html>
<head>
<title>Geoff's First Microblog: Search for '<?php echo $_POST['search']; ?>'</title>
...
<header><h1><a href="http://snm.engl.iastate.edu/313/gsauer/08-php/microblog/"><img src="logo.jpg" width="48" height="36" alt="Logo "></a>Geoff's First Sample: Search Results for '<?php echo $_POST['search']; ?>'</h1></header>
...
echo "<p>".($result->num_rows)." found:</p>";
